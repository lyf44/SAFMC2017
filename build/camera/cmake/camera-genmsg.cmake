...
set(MSG_I_FLAGS "-Icamera:/home/ubuntu/drones/src/camera/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
add_custom_target(_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "camera" "/home/ubuntu/drones/src/camera/msg/IntArray.msg" ""
)

get_filename_component(_filename "/home/ubuntu/drones/src/camera/msg/FloatArray.msg" NAME_WE)
add_custom_target(_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "camera" "/home/ubuntu/drones/src/camera/msg/FloatArray.msg" ""
)
